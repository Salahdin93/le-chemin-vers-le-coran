...
import { HADITH_COLLECTION } from '@/constants/hadithData'; // <-- CHEMIN CORRIGÉ
        ...
        <Card>
            ...
            <Tabs defaultValue="juzz" className="w-full">
                <TabsList className="grid w-full grid-cols-4">
                    <TabsTrigger value="juzz">{t('memorizedJuzz', 'Juzz')}</TabsTrigger>
                    <TabsTrigger value="hizb">{t('memorizedHizbs', 'Hizbs')}</TabsTrigger>
                    <TabsTrigger value="surah">{t('memorizedSurahs', 'Sourates')}</TabsTrigger>
                    <TabsTrigger value="hadith">{t('hadith', 'Hadiths')}</TabsTrigger>
                </TabsList>
                ...
                <TabsContent value="hadith" className="p-6 space-y-2">
                    {memorizedHadiths.length > 0 ? memorizedHadiths.map(h => {
                        const status = activeProfile.hadithProgress[h.id];
                        return (
                    ...
                    }) : <p className='text-sm opacity-70 p-2 text-center'>{t('noMemorizedHadiths', 'Aucun hadith mémorisé.')}</p>}
                </TabsContent>
            </Tabs>
                ...
                {selectedHadith && <>
                    ...
                    <div className="space-y-4 text-left max-h-[60vh] overflow-y-auto p-1">
                        ...
                        <div className="p-3 bg-bg-main rounded-lg border border-border-main text-sm italic">
                            <p>"{selectedHadith.translations[state.settings.lang] || selectedHadith.translations.en}"</p>
                        </div>

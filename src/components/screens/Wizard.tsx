...
const Wizard: FC = () => {
    ...
    const isNewProfileAfterReset = !activeProfile && flow === 'full' && mode === 'new';
    const [formData, setFormData] = useState<Partial<WizardData>>(() => {
        if (isNewProfileAfterReset) {
            return {
                name: '',
                gender: 'male',
                password: '',
                ...
                unitsPerDay: 1,
                revisionDuration: 30,
                revisionFrequency: { type: 'daily', value: 1 },
                boosterSurahs: [],
                boosterSurahFreq: 7,
                resumeDay: 1,
    ...
    const stepsConfig = useMemo(() => [
        ...
        { id: 'hadithSelection', titleKey: 'hadithSelectionTitle', component: StepHadithSelection, condition: flow === 'full' && !!formData.wantsHadith && formData.hadithType === 'revision', requiredFields: ['hadithSelection'] },
    ...
    return (
        <div
            className="fixed inset-0 z-[100] flex flex-col overflow-hidden premium-bg"
        >

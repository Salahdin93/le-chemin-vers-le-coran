...
const Toast: React.FC = () => {
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className={`fixed top-6 left-1/2 z-[120] flex items-center gap-2 px-5 py-3 rounded-full text-sm font-cairo font-semibold text-white select-none pointer-events-none transition-all duration-400 ${visible ? 'opacity-100 translate-y-0 -translate-x-1/2' : 'opacity-0 -translate-y-4 -translate-x-1/2'
        }`}
      style={{
